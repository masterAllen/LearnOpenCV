...
这个模块没法用 Python，涉及的方法也巨多。不细讲了，推荐直接看 [samples 里的代码](https://github.com/opencv/opencv_contrib/blob/4.x/modules/videostab/samples/videostab.cpp)，非常全面和好用。

示例视频可以下载 [pan.avi](../code/video/pan.avi)，原链接为 https://github.com/oberger4711/vstab/blob/master/data/pan.avi

网上看到一篇文章，讲的还可以：https://www.cnblogs.com/hyb1/p/16505121.html
